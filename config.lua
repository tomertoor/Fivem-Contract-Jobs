...
Config["car"] = 
{
    trailerSpawn = vector4(-97.44, 6495.43, 31.49, 230.36), -- trailer for cars
    vehicle = "tr2",
    supplyPoint = vector4(-64.79, 6498.07, 31.49, 129.93),
    delieveryPoint = vector4(-15.84, -1096.75, 26.67, 161.35),
}
Config["gun"] = 
{
...
Config.DeliverMarker = { enable = true, drawDist = 7.5, type = 27, scale = {x = 0.6, y = 0.6, z = 0.6}, color = {r = 255, g = 165, b = 0, a = 100}}